...
public class MySQLTableCreator {
  ...
  public static void main(String[] args) {
    try {
      ...
      // drop the one with foreign keys
      Statement statement = conn.createStatement();
      String sql = "DROP TABLE IF EXISTS favorite_records";
      statement.executeUpdate(sql); // write command: ecxecuteUpdate; read command: executeQuery
...
//      sql = "INSERT INTO users VALUES('1111', '3229c1097c00d497a0fd282d586be050', 'Jay', 'Chou')";
//      statement.executeUpdate(sql);
